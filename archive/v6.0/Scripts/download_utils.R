# =============================================================================
# download_utils.R — Shared helpers for the 00_Download_*.R scripts
# =============================================================================
# Sourced by 00_Download_NHGIS.R and 00_Download_Geology.R. Keeps API-key
# retrieval, network retry, and resumable curl download in one place so the
# two scripts do not drift.
# =============================================================================
